...
| [1 live loop](phase-1-live-loop/) | not started | Drive a real Razorpay test-mode order to a documented failure and back to paid, and confirm the magic-card table against live responses. | not started |
